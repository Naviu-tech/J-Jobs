 ...
 * @property {string} label - The display text for the social link
 * @property {string} url - The URL for the social link
 * @property {string} [icon] - Optional icon name
 */

/**
 * Site configuration used at build time by Astro
 * @type {Object}
 */
export default {
  /**
